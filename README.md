...
Dena - ATM and Customer classes
Baneet - BankTeller and BankAdmin Classes
Faith - BankAccount, Transactions, Checking
Ahmad - Bank and 

Faith - CLI (ATM, Bank Admin & Bank Teller)
Baneeth - Bank Teller CLI

Class Diagram - Faith & Dena
State Diagram - Dena
User TestScript - Faith


Class Diagram
![Class Diagram](FinalClassDiagram.png)

Final Updated CLass Diagram
![Class Diagram](UpdatedClassDiagram.png)

Use Case Diagram
![Use Case Diagram](Grp 5 Bank Use Case Diagram.png)
